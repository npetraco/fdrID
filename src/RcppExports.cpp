...
RcppExport SEXP fdrID_empiricalPvalues(SEXP nullvecSEXP, SEXP vecSEXP) {
BEGIN_RCPP
...
RcppExport SEXP fdrID_compPvals2(SEXP nullvecSEXP, SEXP vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type nullvec(nullvecSEXP);
...
RcppExport SEXP fdrID_compPvals3(SEXP nullvecSEXP, SEXP vecSEXP) {
BEGIN_RCPP
    Rcpp::RObject __result;
    Rcpp::RNGScope __rngScope;
    Rcpp::traits::input_parameter< NumericVector >::type nullvec(nullvecSEXP);
